      ...
      <section class="landing-hero">
        <div class="container">
          ...
          <div class="hero-actions">
            <button id="hero-demo-btn" class="btn btn-primary btn-lg" style="box-shadow: 0 4px 18px var(--primary-purple-glow); font-weight: 700;">
              ⚡ Launch Live Calendar App ➔
            </button>
            <button id="hero-cta-btn" class="btn btn-secondary btn-lg">
              Get Started Free ✨
            </button>
            <button id="hero-how-btn" class="btn btn-ghost btn-lg">
              See How It Works 💡
            </button>
          </div>
